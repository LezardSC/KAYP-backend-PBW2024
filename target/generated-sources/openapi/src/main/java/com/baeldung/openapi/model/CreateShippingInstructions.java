...
@Schema(name = "CreateShippingInstructions", description = "The `Shipping Instructions` is an enrichment to the original booking shared by the Shipper to the Carrier. The information given by the Shipper through the `Shipping Instructions` is the information required to create a `Draft Transport Document`. ")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-09-30T15:24:55.896324973+02:00[Europe/Paris]", comments = "Generator version: 7.8.0")
public class CreateShippingInstructions {
  ...
  public CreateShippingInstructions() {
    super();
  }
  ...
  public CreateShippingInstructions transportDocumentTypeCode(TransportDocumentTypeCodeEnum transportDocumentTypeCode) {
    this.transportDocumentTypeCode = transportDocumentTypeCode;
    return this;
  }
  ...
  public CreateShippingInstructions isShippedOnBoardType(Boolean isShippedOnBoardType) {
    this.isShippedOnBoardType = isShippedOnBoardType;
    return this;
  }
  ...
  public CreateShippingInstructions freightPaymentTermCode(FreightPaymentTermCodeEnum freightPaymentTermCode) {
    this.freightPaymentTermCode = freightPaymentTermCode;
    return this;
  }
  ...
  public CreateShippingInstructions originChargesPaymentTerm(OriginChargesPaymentTerm originChargesPaymentTerm) {
  ...
  public CreateShippingInstructions destinationChargesPaymentTerm(DestinationChargesPaymentTerm destinationChargesPaymentTerm) {
  ...
  public CreateShippingInstructions methodOfPayment(String methodOfPayment) {
  ...
  public CreateShippingInstructions isElectronic(Boolean isElectronic) {
    this.isElectronic = isElectronic;
    return this;
  }
  ...
  public CreateShippingInstructions isToOrder(Boolean isToOrder) {
    this.isToOrder = isToOrder;
    return this;
  }
  ...
  public CreateShippingInstructions numberOfCopiesWithCharges(Integer numberOfCopiesWithCharges) {
  ...
  public CreateShippingInstructions numberOfCopiesWithoutCharges(Integer numberOfCopiesWithoutCharges) {
  ...
  public CreateShippingInstructions numberOfOriginalsWithCharges(Integer numberOfOriginalsWithCharges) {
  ...
  public CreateShippingInstructions numberOfOriginalsWithoutCharges(Integer numberOfOriginalsWithoutCharges) {
  ...
  public CreateShippingInstructions displayedNameForPlaceOfReceipt(List<@Size(max = 35)String> displayedNameForPlaceOfReceipt) {
    this.displayedNameForPlaceOfReceipt = displayedNameForPlaceOfReceipt;
    return this;
  }

  public CreateShippingInstructions addDisplayedNameForPlaceOfReceiptItem(String displayedNameForPlaceOfReceiptItem) {
  ...
  public CreateShippingInstructions displayedNameForPortOfLoad(List<@Size(max = 35)String> displayedNameForPortOfLoad) {
    this.displayedNameForPortOfLoad = displayedNameForPortOfLoad;
    return this;
  }

  public CreateShippingInstructions addDisplayedNameForPortOfLoadItem(String displayedNameForPortOfLoadItem) {
  ...
  public CreateShippingInstructions displayedNameForPortOfDischarge(List<@Size(max = 35)String> displayedNameForPortOfDischarge) {
    this.displayedNameForPortOfDischarge = displayedNameForPortOfDischarge;
    return this;
  }

  public CreateShippingInstructions addDisplayedNameForPortOfDischargeItem(String displayedNameForPortOfDischargeItem) {
  ...
  public CreateShippingInstructions displayedNameForPlaceOfDelivery(List<@Size(max = 35)String> displayedNameForPlaceOfDelivery) {
    this.displayedNameForPlaceOfDelivery = displayedNameForPlaceOfDelivery;
    return this;
  }

  public CreateShippingInstructions addDisplayedNameForPlaceOfDeliveryItem(String displayedNameForPlaceOfDeliveryItem) {
  ...
  public CreateShippingInstructions placeOfIssue(PlaceOfIssue placeOfIssue) {
  ...
  public CreateShippingInstructions invoicePayableAt(InvoicePayableAt invoicePayableAt) {
  ...
  public CreateShippingInstructions partyContactDetails(List<@Valid PartyContactDetail> partyContactDetails) {
    this.partyContactDetails = partyContactDetails;
    return this;
  }

  public CreateShippingInstructions addPartyContactDetailsItem(PartyContactDetail partyContactDetailsItem) {
  ...
  public CreateShippingInstructions isCarriersAgentAtDestinationRequired(Boolean isCarriersAgentAtDestinationRequired) {
  ...
  public CreateShippingInstructions documentParties(DocumentParties documentParties) {
    this.documentParties = documentParties;
    return this;
  }
  ...
  public CreateShippingInstructions routingOfConsignmentCountries(List<@Pattern(regexp = "^[A-Z]{2}$")@Size(min = 2, max = 2)String> routingOfConsignmentCountries) {
    this.routingOfConsignmentCountries = routingOfConsignmentCountries;
    return this;
  }

  public CreateShippingInstructions addRoutingOfConsignmentCountriesItem(String routingOfConsignmentCountriesItem) {
  ...
  public CreateShippingInstructions consignmentItems(List<@Valid ConsignmentItemShipper> consignmentItems) {
    this.consignmentItems = consignmentItems;
    return this;
  }

  public CreateShippingInstructions addConsignmentItemsItem(ConsignmentItemShipper consignmentItemsItem) {
  ...
  public CreateShippingInstructions utilizedTransportEquipments(List<@Valid UtilizedTransportEquipmentShipper> utilizedTransportEquipments) {
    this.utilizedTransportEquipments = utilizedTransportEquipments;
    return this;
  }

  public CreateShippingInstructions addUtilizedTransportEquipmentsItem(UtilizedTransportEquipmentShipper utilizedTransportEquipmentsItem) {
  ...
  public CreateShippingInstructions references(List<@Valid Reference> references) {
    this.references = references;
    return this;
  }

  public CreateShippingInstructions addReferencesItem(Reference referencesItem) {
  ...
  public CreateShippingInstructions customsReferences(List<@Valid CustomsReference> customsReferences) {
    this.customsReferences = customsReferences;
    return this;
  }

  public CreateShippingInstructions addCustomsReferencesItem(CustomsReference customsReferencesItem) {
  ...
  public CreateShippingInstructions advanceManifestFilings(List<@Valid AdvanceManifestFiling> advanceManifestFilings) {
    this.advanceManifestFilings = advanceManifestFilings;
    return this;
  }

  public CreateShippingInstructions addAdvanceManifestFilingsItem(AdvanceManifestFiling advanceManifestFilingsItem) {
  ...
  public CreateShippingInstructions isHBLIssued(Boolean isHBLIssued) {
  ...
  public CreateShippingInstructions houseBillOfLadings(List<@Valid HouseBillOfLading> houseBillOfLadings) {
    this.houseBillOfLadings = houseBillOfLadings;
    return this;
  }

  public CreateShippingInstructions addHouseBillOfLadingsItem(HouseBillOfLading houseBillOfLadingsItem) {
  ...
  public CreateShippingInstructions requestedCarrierCertificates(List<@Size(max = 100)String> requestedCarrierCertificates) {
    this.requestedCarrierCertificates = requestedCarrierCertificates;
    return this;
  }

  public CreateShippingInstructions addRequestedCarrierCertificatesItem(String requestedCarrierCertificatesItem) {
  ...
  public CreateShippingInstructions requestedCarrierClauses(List<@Size(max = 100)String> requestedCarrierClauses) {
    this.requestedCarrierClauses = requestedCarrierClauses;
    return this;
  }

  public CreateShippingInstructions addRequestedCarrierClausesItem(String requestedCarrierClausesItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateShippingInstructions createShippingInstructions = (CreateShippingInstructions) o;
    return Objects.equals(this.transportDocumentTypeCode, createShippingInstructions.transportDocumentTypeCode) &&
        Objects.equals(this.isShippedOnBoardType, createShippingInstructions.isShippedOnBoardType) &&
        Objects.equals(this.freightPaymentTermCode, createShippingInstructions.freightPaymentTermCode) &&
        Objects.equals(this.originChargesPaymentTerm, createShippingInstructions.originChargesPaymentTerm) &&
        Objects.equals(this.destinationChargesPaymentTerm, createShippingInstructions.destinationChargesPaymentTerm) &&
        Objects.equals(this.methodOfPayment, createShippingInstructions.methodOfPayment) &&
        Objects.equals(this.isElectronic, createShippingInstructions.isElectronic) &&
        Objects.equals(this.isToOrder, createShippingInstructions.isToOrder) &&
        Objects.equals(this.numberOfCopiesWithCharges, createShippingInstructions.numberOfCopiesWithCharges) &&
        Objects.equals(this.numberOfCopiesWithoutCharges, createShippingInstructions.numberOfCopiesWithoutCharges) &&
        Objects.equals(this.numberOfOriginalsWithCharges, createShippingInstructions.numberOfOriginalsWithCharges) &&
        Objects.equals(this.numberOfOriginalsWithoutCharges, createShippingInstructions.numberOfOriginalsWithoutCharges) &&
        Objects.equals(this.displayedNameForPlaceOfReceipt, createShippingInstructions.displayedNameForPlaceOfReceipt) &&
        Objects.equals(this.displayedNameForPortOfLoad, createShippingInstructions.displayedNameForPortOfLoad) &&
        Objects.equals(this.displayedNameForPortOfDischarge, createShippingInstructions.displayedNameForPortOfDischarge) &&
        Objects.equals(this.displayedNameForPlaceOfDelivery, createShippingInstructions.displayedNameForPlaceOfDelivery) &&
        Objects.equals(this.placeOfIssue, createShippingInstructions.placeOfIssue) &&
        Objects.equals(this.invoicePayableAt, createShippingInstructions.invoicePayableAt) &&
        Objects.equals(this.partyContactDetails, createShippingInstructions.partyContactDetails) &&
        Objects.equals(this.isCarriersAgentAtDestinationRequired, createShippingInstructions.isCarriersAgentAtDestinationRequired) &&
        Objects.equals(this.documentParties, createShippingInstructions.documentParties) &&
        Objects.equals(this.routingOfConsignmentCountries, createShippingInstructions.routingOfConsignmentCountries) &&
        Objects.equals(this.consignmentItems, createShippingInstructions.consignmentItems) &&
        Objects.equals(this.utilizedTransportEquipments, createShippingInstructions.utilizedTransportEquipments) &&
        Objects.equals(this.references, createShippingInstructions.references) &&
        Objects.equals(this.customsReferences, createShippingInstructions.customsReferences) &&
        Objects.equals(this.advanceManifestFilings, createShippingInstructions.advanceManifestFilings) &&
        Objects.equals(this.isHBLIssued, createShippingInstructions.isHBLIssued) &&
        Objects.equals(this.houseBillOfLadings, createShippingInstructions.houseBillOfLadings) &&
        Objects.equals(this.requestedCarrierCertificates, createShippingInstructions.requestedCarrierCertificates) &&
        Objects.equals(this.requestedCarrierClauses, createShippingInstructions.requestedCarrierClauses);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transportDocumentTypeCode, isShippedOnBoardType, freightPaymentTermCode, originChargesPaymentTerm, destinationChargesPaymentTerm, methodOfPayment, isElectronic, isToOrder, numberOfCopiesWithCharges, numberOfCopiesWithoutCharges, numberOfOriginalsWithCharges, numberOfOriginalsWithoutCharges, displayedNameForPlaceOfReceipt, displayedNameForPortOfLoad, displayedNameForPortOfDischarge, displayedNameForPlaceOfDelivery, placeOfIssue, invoicePayableAt, partyContactDetails, isCarriersAgentAtDestinationRequired, documentParties, routingOfConsignmentCountries, consignmentItems, utilizedTransportEquipments, references, customsReferences, advanceManifestFilings, isHBLIssued, houseBillOfLadings, requestedCarrierCertificates, requestedCarrierClauses);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateShippingInstructions {\n");
