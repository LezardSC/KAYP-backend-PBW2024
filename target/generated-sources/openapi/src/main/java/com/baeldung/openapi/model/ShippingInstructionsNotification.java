...
import com.baeldung.openapi.model.Data;
...
@Schema(name = "ShippingInstructionsNotification", description = "`CloudEvent` specific properties for the `Notification`. ")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-09-30T15:24:55.896324973+02:00[Europe/Paris]", comments = "Generator version: 7.8.0")
public class ShippingInstructionsNotification {
  ...
  public enum TypeEnum {
    ORG_DCSA_SHIPPING_INSTRUCTIONS_V3("org.dcsa.shipping-instructions.v3");
  ...
  public ShippingInstructionsNotification() {
    super();
  }
   ...
   */
  public ShippingInstructionsNotification(SpecversionEnum specversion, String id, String source, TypeEnum type, OffsetDateTime time, DatacontenttypeEnum datacontenttype, String subscriptionReference, Data data) {
  ...
  public ShippingInstructionsNotification specversion(SpecversionEnum specversion) {
    this.specversion = specversion;
    return this;
  }
  ...
  public ShippingInstructionsNotification id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ShippingInstructionsNotification source(String source) {
    this.source = source;
    return this;
  }
  ...
  public ShippingInstructionsNotification type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ShippingInstructionsNotification time(OffsetDateTime time) {
    this.time = time;
    return this;
  }
  ...
  public ShippingInstructionsNotification datacontenttype(DatacontenttypeEnum datacontenttype) {
    this.datacontenttype = datacontenttype;
    return this;
  }
  ...
  public ShippingInstructionsNotification subscriptionReference(String subscriptionReference) {
    this.subscriptionReference = subscriptionReference;
    return this;
  }
  ...
  public ShippingInstructionsNotification data(Data data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ShippingInstructionsNotification shippingInstructionsNotification = (ShippingInstructionsNotification) o;
    return Objects.equals(this.specversion, shippingInstructionsNotification.specversion) &&
        Objects.equals(this.id, shippingInstructionsNotification.id) &&
        Objects.equals(this.source, shippingInstructionsNotification.source) &&
        Objects.equals(this.type, shippingInstructionsNotification.type) &&
        Objects.equals(this.time, shippingInstructionsNotification.time) &&
        Objects.equals(this.datacontenttype, shippingInstructionsNotification.datacontenttype) &&
        Objects.equals(this.subscriptionReference, shippingInstructionsNotification.subscriptionReference) &&
        Objects.equals(this.data, shippingInstructionsNotification.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingInstructionsNotification {\n");
