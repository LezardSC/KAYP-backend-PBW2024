...
@Schema(name = "Equipment", description = "Used for storing cargo in/on during transport. The equipment size/type is defined by the ISO 6346 code. The most common equipment size/type is 20'/40'/45' DRY Freight Container, but several different versions exist. ")
...
public class Equipment {
   ...
   */
  public Equipment(String equipmentReference) {
    this.equipmentReference = equipmentReference;
  }

  public Equipment equipmentReference(String equipmentReference) {
    this.equipmentReference = equipmentReference;
    return this;
  }
  ...
  public Equipment isOEquipmentCode(String isOEquipmentCode) {
  ...
  public Equipment tareWeight(TareWeight tareWeight) {
   ...
   */
  @Valid 
  @Schema(name = "tareWeight", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.equipmentReference, equipment.equipmentReference) &&
        Objects.equals(this.isOEquipmentCode, equipment.isOEquipmentCode) &&
        Objects.equals(this.tareWeight, equipment.tareWeight);
  }
