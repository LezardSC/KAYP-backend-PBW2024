...
import com.baeldung.openapi.model.OuterPackagingShipper;
...
@Schema(name = "CargoItemShipper", description = "A `cargoItem` is the smallest unit used by stuffing. A `cargoItem` cannot be split across containers. ")
...
public class CargoItemShipper {
   ...
   */
  public CargoItemShipper(String equipmentReference, CargoGrossWeight cargoGrossWeight) {
    this.equipmentReference = equipmentReference;
    this.cargoGrossWeight = cargoGrossWeight;
  }

  public CargoItemShipper equipmentReference(String equipmentReference) {
    this.equipmentReference = equipmentReference;
    return this;
  }
  ...
  public CargoItemShipper cargoGrossWeight(CargoGrossWeight cargoGrossWeight) {
    this.cargoGrossWeight = cargoGrossWeight;
    return this;
  }
  ...
  public CargoItemShipper cargoGrossVolume(CargoGrossVolume cargoGrossVolume) {
  ...
  public CargoItemShipper cargoNetWeight(CargoNetWeight cargoNetWeight) {
  ...
  public CargoItemShipper cargoNetVolume(CargoNetVolume cargoNetVolume) {
  ...
  public CargoItemShipper outerPackaging(OuterPackagingShipper outerPackaging) {
   ...
   */
  @Valid 
  @Schema(name = "outerPackaging", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("outerPackaging")
  public OuterPackagingShipper getOuterPackaging() {
    return outerPackaging;
  }

  public void setOuterPackaging(OuterPackagingShipper outerPackaging) {
    this.outerPackaging = outerPackaging;
  }

  public CargoItemShipper nationalCommodityCodes(List<@Valid NationalCommodityCode> nationalCommodityCodes) {
    this.nationalCommodityCodes = nationalCommodityCodes;
    return this;
  }

  public CargoItemShipper addNationalCommodityCodesItem(NationalCommodityCode nationalCommodityCodesItem) {
  ...
  public CargoItemShipper houseBillOfLadingReference(String houseBillOfLadingReference) {
  ...
  @Schema(name = "houseBillOfLadingReference", example = "ABC123", description = "Link to the House Bill of Lading this cargoItem is connected to. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public CargoItemShipper customsReferences(List<@Valid CustomsReference> customsReferences) {
    this.customsReferences = customsReferences;
    return this;
  }

  public CargoItemShipper addCustomsReferencesItem(CustomsReference customsReferencesItem) {
  ...
  public boolean equals(Object o) {
    ...
    CargoItemShipper cargoItemShipper = (CargoItemShipper) o;
    return Objects.equals(this.equipmentReference, cargoItemShipper.equipmentReference) &&
        Objects.equals(this.cargoGrossWeight, cargoItemShipper.cargoGrossWeight) &&
        Objects.equals(this.cargoGrossVolume, cargoItemShipper.cargoGrossVolume) &&
        Objects.equals(this.cargoNetWeight, cargoItemShipper.cargoNetWeight) &&
        Objects.equals(this.cargoNetVolume, cargoItemShipper.cargoNetVolume) &&
        Objects.equals(this.outerPackaging, cargoItemShipper.outerPackaging) &&
        Objects.equals(this.nationalCommodityCodes, cargoItemShipper.nationalCommodityCodes) &&
        Objects.equals(this.houseBillOfLadingReference, cargoItemShipper.houseBillOfLadingReference) &&
        Objects.equals(this.customsReferences, cargoItemShipper.customsReferences);
  }

  @Override
  public int hashCode() {
    return Objects.hash(equipmentReference, cargoGrossWeight, cargoGrossVolume, cargoNetWeight, cargoNetVolume, outerPackaging, nationalCommodityCodes, houseBillOfLadingReference, customsReferences);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CargoItemShipper {\n");
