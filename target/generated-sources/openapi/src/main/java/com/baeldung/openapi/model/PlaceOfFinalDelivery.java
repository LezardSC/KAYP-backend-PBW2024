...
/**
 * An object to capture &#x60;Place of Final Delivery&#x60; location specified as: Identification of the seaport, freight terminal or other place at which the goods are handed over from the &#x60;Ocean Transport Intermediary&#x60; (OTI) issuing the &#x60;House Bill of Lading&#x60; to the &#x60;Consignee&#x60;.  **Condition:** Mandatory if different from &#x60;Place of Delivery&#x60; at the &#x60;Master Transport Document&#x60; level. (**Note:** in case of carrier haulage this will be the same as the &#x60;Place of Delivery&#x60;)  The location can be specified in **any** of the following ways: &#x60;UN Location Code&#x60;, &#x60;Facility&#x60;, an &#x60;Address&#x60; or a &#x60;GeoCoordinate&#x60;.  **Condition:** It is expected that if a location is specified in multiple ways (e.g. both as an &#x60;Address&#x60; and as a &#x60;Facility&#x60;) that both ways point to the same location. 
 */

@Schema(name = "PlaceOfFinalDelivery", description = "An object to capture `Place of Final Delivery` location specified as: Identification of the seaport, freight terminal or other place at which the goods are handed over from the `Ocean Transport Intermediary` (OTI) issuing the `House Bill of Lading` to the `Consignee`.  **Condition:** Mandatory if different from `Place of Delivery` at the `Master Transport Document` level. (**Note:** in case of carrier haulage this will be the same as the `Place of Delivery`)  The location can be specified in **any** of the following ways: `UN Location Code`, `Facility`, an `Address` or a `GeoCoordinate`.  **Condition:** It is expected that if a location is specified in multiple ways (e.g. both as an `Address` and as a `Facility`) that both ways point to the same location. ")
...
public class PlaceOfFinalDelivery {
  ...
  public PlaceOfFinalDelivery locationName(String locationName) {
  ...
  public PlaceOfFinalDelivery address(Address address) {
  ...
  public PlaceOfFinalDelivery facility(Facility facility) {
  ...
  public PlaceOfFinalDelivery unLocationCode(String unLocationCode) {
  ...
  public PlaceOfFinalDelivery geoCoordinate(GeoCoordinate geoCoordinate) {
  ...
  public boolean equals(Object o) {
    ...
    PlaceOfFinalDelivery placeOfFinalDelivery = (PlaceOfFinalDelivery) o;
    return Objects.equals(this.locationName, placeOfFinalDelivery.locationName) &&
        Objects.equals(this.address, placeOfFinalDelivery.address) &&
        Objects.equals(this.facility, placeOfFinalDelivery.facility) &&
        Objects.equals(this.unLocationCode, placeOfFinalDelivery.unLocationCode) &&
        Objects.equals(this.geoCoordinate, placeOfFinalDelivery.geoCoordinate);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlaceOfFinalDelivery {\n");
