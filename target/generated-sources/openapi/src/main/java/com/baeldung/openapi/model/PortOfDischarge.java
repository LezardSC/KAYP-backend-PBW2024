...
@Schema(name = "PortOfDischarge", description = "An object to capture `Port of Discharge` location specified as: the location where the cargo is discharged from the last sea-going vessel.  The location can be specified in **any** of the following ways: `UN Location Code` or `City and Country`.  **Condition:** It is expected that if a location is specified in multiple ways (e.g. both as an `UN Location Code` and as a `City and Country`) that both ways point to the same location. ")
...
public class PortOfDischarge {
  ...
  public PortOfDischarge locationName(String locationName) {
  ...
  public PortOfDischarge city(City city) {
    this.city = city;
    return this;
  }
  ...
  public PortOfDischarge unLocationCode(String unLocationCode) {
  ...
  public boolean equals(Object o) {
    ...
    PortOfDischarge portOfDischarge = (PortOfDischarge) o;
    return Objects.equals(this.locationName, portOfDischarge.locationName) &&
        Objects.equals(this.city, portOfDischarge.city) &&
        Objects.equals(this.unLocationCode, portOfDischarge.unLocationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortOfDischarge {\n");
