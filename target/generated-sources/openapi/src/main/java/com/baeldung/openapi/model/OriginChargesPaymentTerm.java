...
@Schema(name = "OriginChargesPaymentTerm", description = "An indicator of whether origin charges are prepaid (`PRE`) or collect (`COL`). When prepaid, the charges are the responsibility of the shipper or the Invoice payer on behalf of the shipper (if provided). When collect, the charges are the responsibility of the consignee or the Invoice payer on behalf of the consignee (if provided). ")
...
public class OriginChargesPaymentTerm {
  ...
  /**
   * An indicator of whether the origin port charges are prepaid (`PRE`) or collect (`COL`).  - `PRE` (Prepaid) - `COL` (Collect) 
   */
  ...
  /**
   * An indicator of whether origin charges (excluding port and haulage) are prepaid (`PRE`) or collect (`COL`).  - `PRE` (Prepaid) - `COL` (Collect) 
   */
  ...
  public OriginChargesPaymentTerm haulageChargesPaymentTermCode(HaulageChargesPaymentTermCodeEnum haulageChargesPaymentTermCode) {
  ...
  public OriginChargesPaymentTerm portChargesPaymentTermCode(PortChargesPaymentTermCodeEnum portChargesPaymentTermCode) {
  ...
  @Schema(name = "portChargesPaymentTermCode", example = "PRE", description = "An indicator of whether the origin port charges are prepaid (`PRE`) or collect (`COL`).  - `PRE` (Prepaid) - `COL` (Collect) ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public OriginChargesPaymentTerm otherChargesPaymentTermCode(OtherChargesPaymentTermCodeEnum otherChargesPaymentTermCode) {
  ...
  @Schema(name = "otherChargesPaymentTermCode", example = "PRE", description = "An indicator of whether origin charges (excluding port and haulage) are prepaid (`PRE`) or collect (`COL`).  - `PRE` (Prepaid) - `COL` (Collect) ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    OriginChargesPaymentTerm originChargesPaymentTerm = (OriginChargesPaymentTerm) o;
    return Objects.equals(this.haulageChargesPaymentTermCode, originChargesPaymentTerm.haulageChargesPaymentTermCode) &&
        Objects.equals(this.portChargesPaymentTermCode, originChargesPaymentTerm.portChargesPaymentTermCode) &&
        Objects.equals(this.otherChargesPaymentTermCode, originChargesPaymentTerm.otherChargesPaymentTermCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class OriginChargesPaymentTerm {\n");
