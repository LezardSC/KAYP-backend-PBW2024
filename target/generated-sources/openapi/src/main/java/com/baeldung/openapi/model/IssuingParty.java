...
@Schema(name = "IssuingParty", description = "Refers to a company or a legal entity. ")
...
public class IssuingParty {
   ...
   */
  public IssuingParty(String partyName, PartyAddress address) {
    this.partyName = partyName;
    this.address = address;
  }

  public IssuingParty partyName(String partyName) {
    this.partyName = partyName;
    return this;
  }
  ...
  public IssuingParty address(PartyAddress address) {
    this.address = address;
    return this;
  }
  ...
  public IssuingParty identifyingCodes(List<@Valid IdentifyingCode> identifyingCodes) {
    this.identifyingCodes = identifyingCodes;
    return this;
  }

  public IssuingParty addIdentifyingCodesItem(IdentifyingCode identifyingCodesItem) {
  ...
  public IssuingParty taxLegalReferences(List<@Valid TaxLegalReference> taxLegalReferences) {
    this.taxLegalReferences = taxLegalReferences;
    return this;
  }

  public IssuingParty addTaxLegalReferencesItem(TaxLegalReference taxLegalReferencesItem) {
  ...
  public IssuingParty partyContactDetails(List<@Valid PartyContactDetail> partyContactDetails) {
    this.partyContactDetails = partyContactDetails;
    return this;
  }

  public IssuingParty addPartyContactDetailsItem(PartyContactDetail partyContactDetailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    IssuingParty issuingParty = (IssuingParty) o;
    return Objects.equals(this.partyName, issuingParty.partyName) &&
        Objects.equals(this.address, issuingParty.address) &&
        Objects.equals(this.identifyingCodes, issuingParty.identifyingCodes) &&
        Objects.equals(this.taxLegalReferences, issuingParty.taxLegalReferences) &&
        Objects.equals(this.partyContactDetails, issuingParty.partyContactDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(partyName, address, identifyingCodes, taxLegalReferences, partyContactDetails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IssuingParty {\n");
