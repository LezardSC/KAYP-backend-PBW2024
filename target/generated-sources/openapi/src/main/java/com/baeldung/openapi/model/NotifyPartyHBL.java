...
@Schema(name = "NotifyPartyHBL", description = "The person to be notified when a shipment arrives at its destination. ")
...
public class NotifyPartyHBL {
   ...
   */
  public NotifyPartyHBL(String partyName) {
    this.partyName = partyName;
  }

  public NotifyPartyHBL partyName(String partyName) {
    this.partyName = partyName;
    return this;
  }
  ...
  public NotifyPartyHBL typeOfPerson(String typeOfPerson) {
  ...
  public NotifyPartyHBL address(PartyAddress address) {
  ...
  public NotifyPartyHBL identifyingCodes(List<@Valid IdentifyingCode> identifyingCodes) {
    this.identifyingCodes = identifyingCodes;
    return this;
  }

  public NotifyPartyHBL addIdentifyingCodesItem(IdentifyingCode identifyingCodesItem) {
  ...
  public NotifyPartyHBL taxLegalReferences(List<@Valid TaxLegalReference> taxLegalReferences) {
    this.taxLegalReferences = taxLegalReferences;
    return this;
  }

  public NotifyPartyHBL addTaxLegalReferencesItem(TaxLegalReference taxLegalReferencesItem) {
  ...
  public NotifyPartyHBL partyContactDetails(List<@Valid PartyContactDetail> partyContactDetails) {
    this.partyContactDetails = partyContactDetails;
    return this;
  }

  public NotifyPartyHBL addPartyContactDetailsItem(PartyContactDetail partyContactDetailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyPartyHBL notifyPartyHBL = (NotifyPartyHBL) o;
    return Objects.equals(this.partyName, notifyPartyHBL.partyName) &&
        Objects.equals(this.typeOfPerson, notifyPartyHBL.typeOfPerson) &&
        Objects.equals(this.address, notifyPartyHBL.address) &&
        Objects.equals(this.identifyingCodes, notifyPartyHBL.identifyingCodes) &&
        Objects.equals(this.taxLegalReferences, notifyPartyHBL.taxLegalReferences) &&
        Objects.equals(this.partyContactDetails, notifyPartyHBL.partyContactDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyPartyHBL {\n");
